...
Out-of-the box, it integrates nicely with [OTRS (Opensource Ticket Request System)][1], one of the most widely used ticketing systems. 
...
> http://your-server.com:3000/ratings/new/[ticket_id]/[hash]
    

Where [hash] is a control hash used for validation.
It is computed from the ticket id and the shared secret (stored in OPENREPLY_OTRS_SHARED_SECRET variable in .env)
